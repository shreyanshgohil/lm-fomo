...
import { PageContainer, StickyColumn } from "../components/layout";
import {
  PulseColorPicker,
...
import { toWidgetSettingsState } from "../utils/widgetSettingsState";
        ...
        <BlockStack gap="400">
          <SectionCard>
            ...
            <SettingsSection
              ...
              description="Background and border styling for the storefront widget"
            >
              <WidgetAppearanceFields
                ...
                onBorderEnabledChange={(borderEnabled) =>
                  update("borderEnabled", borderEnabled)
                }
